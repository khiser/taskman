...
it's the contact page, added at the end the GOOGLE MAP API for the map. Fully functional version thanks to the PHP script.
/////////////////////////////////////////////////////////////////////-->
<?php 
/*
 * *****************************************************************************
        ...
        <div id="page">
            ...
            <section id="wrapper_top">
                        ...
                        <div class="container">
                            ...
                            <nav class="pull-right navmenu">
                                <ul class="unstyled sf-menu">
                                    ...
                                    <li>
                                        <a href="portfolio_4col.html" class="btn-menu">Portfolio</a>
                                            <ul class="unstyled">
                                    ...
                                    <li>
                                        <a href="features.html" class="btn-menu">Pages</a>
                                            <ul class="unstyled">
                                    ...
                                    <li>
                                        <a href="blog.html" class="btn-menu">Blog</a>
                                            <ul class="unstyled">
                ...
                <section id="wrapper_slider" class="container">
                    ...
                    <h2 class="page_name text_shadow">Contact Us</h2>
                    <h3 class="breadcrumb text_shadow">Home / Contact Us</h3>
                            ...
                            <form class="form-horizontal" id="form_contact" method="post" action="contact.php">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><input type="text" class="input-xlarge" name="contact_email" id="contact_email"></div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><textarea id="contact_textarea" rows="4" name="contact_textarea"></textarea></div>
                                    </div>
                                        <div class="controls"><button type="submit" class="btn" id="submitted" name="submitted">Send</button></div>
                                </fieldset>
                            </form>
                        </div><!-- end .span6 m1 -->
                        ...
                        <div class="row">
                            ...
                            <div id="second" class="widget_area span4 m1" role="complementary">
                                ...
                                <div id="slider_news" class="widget_news">
                                    <div class="news_slides_container rsDefaultInv">
                                        <div class="rsImage">
                                    ...
                                    <div class="btn-group slider_news_controls">
                                        <button class="btn" id="slider_news_prev"><i class="icon-chevron-left icon_grey"></i></button>
										<button class="btn" id="slider_news_next"><i class="icon-chevron-right icon_grey"></i></button>
                                    </div>
                                </div><!-- end #slider_news -->
                            </div><!-- end #second -->
