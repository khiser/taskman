...
class Project extends TrackStarActiveRecord
{
	...
	public static function model($className=__CLASS__)
	{
        ...
        /*
         * Create an association between role, user, and project.
         * @params '$role', 'project_id' and ''$userId'
         */
        ...
        /* Remove an association between role, user, and project
         * @params '$userId'
         */
        public function removeUser($userId)
        {
            ...
            $command->delete(
                    ...
                    array(':userId'=>$userId,':project_id'=>$this->id));
        }
        
        /* Determines if a users is associated with a role within the project
         * @params '$role'
         */
        public function allowCurrentUser($role)
        {
            $sql = "SELECT * FROM tbl_project_user_assigment WHERE project_id=:projectId AND
        ...
        /*
         * Returns an array of available roles in which a user can be placed when added to a project
         */
